...
#define PITCH_A_PID_KD 0.09
#define PITCH_A_PID_KP_AIMASSIST 0.55
#define PITCH_A_PID_KI_AIMASSIST 0.1
#define PITCH_A_PID_KD_AIMASSIST 0
#define PITCH_A_PID_LPF 0.0001
#define PITCH_A_PID_D_LPF 0.001

#define PITCH_T_PID_MAXOUT 30000
#define PITCH_T_PID_MAXINTEGRAL 30000
#define PITCH_T_PID_KP 0  
#define PITCH_T_PID_KI 300  
#define PITCH_T_PID_KD 0
#define PITCH_T_PID_LPF 0.0
