...
{
    NONE = 0x000,                        // 0000 0000 0000
    Integral_Limit = 0x001,              // 0000 0000 0001
    Derivative_On_Measurement = 0x002,   // 0000 0000 0010
    Trapezoid_Intergral = 0x004,         // 0000 0000 0100
    Proportional_On_Measurement = 0x008, // 0000 0000 1000
    OutputFilter = 0x010,                // 0000 0001 0000
    ChangingIntegrationRate = 0x020,     // 0000 0010 0000
    DerivativeFilter = 0x040,            // 0000 0100 0000
    ErrorHandle = 0x080,                 // 0000 1000 0000
    ErrorWrapping = 0x100,               // 0001 0000 0000
} PID_Improvement_e;
